...
export const getUserPostImages = createAsyncThunk('auth/getUserPostImages', async (payload) => {
  console.log('HEEEEEEEEYYYYYYYAAAAAAAAAAAAAAAAAA')
  console.log('HEEEEEEEEYYYYYYYAAAAAAAAAAAAAAAAAA')
  ...
  let data = []
  try {
    response = await fetch(`${BASE_URL}/api/v1/getAllPostImagesFromUser`, configNewPost)
