...
import smallPlusBlack from "../../assets/icons/smallPlusBlack.png";
import smallTripleEqualBlack from "../../assets/icons/smallTripleEqualBlack.png";
import smallArrowBlack from "../../assets/icons/smallArrowBlack.png";

import "../../Styles/friends/friends-menu.scss"
import { useEffect } from "react";
const FriendsPageMenu = (props) => {

  let allFriendsOptionElem = document.querySelector('.friends-page-menu-option.all-friends')
  let invitationsOptionElem = document.querySelector('.friends-page-menu-option.invitations')
  let suggestionsOptionElem = document.querySelector('.friends-page-menu-option.suggestions')

  let allFriendsOptionCircle = document.querySelector('.friends-page-menu-option-avatar.all-friends')
  let invitationsOptionCircle = document.querySelector('.friends-page-menu-option-avatar.invitations')
  let suggestionsOptionCircle = document.querySelector('.friends-page-menu-option-avatar.suggestions')

  let smallIconsAllFriends = document.querySelectorAll('.friends-page-menu-small-icon-line')
  let smallIconInvitations = document.querySelector('.friends-page-menu-small-icon-invitations')
  let smallIconSuggestions = document.querySelector('.friends-page-menu-small-icon-arrow-el')
  ...
  if (allFriendsOptionElem !== null && invitationsOptionElem !== null && suggestionsOptionElem !== null) {
  ...
  return (
    <div className="friends-page-menu-container">
      ...
      <div className="friends-page-menu-list">
        ...
        <div className="friends-page-menu-option all-friends"id="all-friends" onClick={(e)=>changeMenu(e)} >
          <div className="friends-page-menu-option-avatar all-friends">
            {props.menuSelected === 'all-friends' ?
              <img className="friends-page-menu-img-user" src={singleUserWhite} alt="all friends"></img>
              :
              <img className="friends-page-menu-img-user" src={singleUserBlack} alt="all friends"></img>
            }
          ...
          <div className="friends-page-menu-btn">
            <img className="friends-page-menu-chevron all-friends" src={chevronIcon} alt="all friends"/>
          </div>
        </div>

        <div className="friends-page-menu-option invitations" id="invitations" onClick={(e)=>changeMenu(e)}>
          ...
          <div className="friends-page-menu-btn">
            <img className="friends-page-menu-chevron invitations" src={chevronIcon} alt="all friends"/>
          </div>
        </div>

        <div className="friends-page-menu-option suggestions" id="suggestions" onClick={(e)=>changeMenu(e)}>
          ...
          {props.menuSelected === 'suggestions' ?
            ...
            <div className="friends-page-menu-small-icon-arrow-container">
              <div className="friends-page-menu-small-icon-arrow-el">&#8594;</div>
            </div>
          </div>
          <div className="friends-page-menu-tag suggestions">Suggestions</div>
          <div className="friends-page-menu-btn">
            <img className="friends-page-menu-chevron suggestions" src={chevronIcon} alt="all friends"/>
          </div>
        </div>
