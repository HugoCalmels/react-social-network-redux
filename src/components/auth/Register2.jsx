...
const Register2 = (props) => {
  ...
  const errorMessagesElements = document.querySelectorAll('.register-input-error')
  const errorMessageElemUsername = document.querySelector('.register-input-error.username')
  const errorMessageElemEmail = document.querySelector('.register-input-error.email')
  const errorMessageElemEmailValidation = document.querySelector('.register-input-error.emailValidation')
  const errorMessageElemPassword = document.querySelector('.register-input-error.password')
  ...
  const inputEmailValidationElem = document.querySelector('.register-input.emailValidation')
  ...
  const errorBtnEmailValidation = document.querySelector('.error-red.emailValidation')
  const errorBtnPassword = document.querySelector('.error-red.password')
  const [focus, setFocus] = useState(true)
  const hiddenEmailValidationInput = document.querySelector('.register-input-container.emailValidation')
  ...
  const testOverlay = (e) => {
    ...
    if (e.target.id !== 'register-btn' && e.target.id !== "register-close-img") {
      ...
      if (lastError === "emailValidation"&& e.target.id.split('-')[2] !== 'emailValidation') {
      ...
      if (openedError === "username" && e.target.id.split('-')[2] !== 'username') {
        errorBtnUsername.style.display ="flex"
      }
      if (openedError === "email" && e.target.id.split('-')[2] !== 'email') {
        errorBtnEmail.style.display ="flex"
      }
      if (openedError === "emailValidation" && e.target.id.split('-')[2] !== 'emailValidation') {
        errorBtnEmailValidation.style.display ="flex"
      }
      if (openedError === "password" && e.target.id.split('-')[2] !== 'password') {
        errorBtnPassword.style.display ="flex"
      }
    }
  ...
  const testForValidation = (input) => {
    ...
    console.log(lastClick.id.split('-')[2])
    console.log('AAAAAA')
    if (input.id.split('-')[2] === currentInput && lastClick.id.split('-')[2] === currentInput || lastClick === '') {
    ...
    /*
    if (openedError === 'username') {
      errorBtnUsername.style.display = "flex"
    } else if (openedError === 'email') {
      errorBtnEmail.style.display = "flex"
    } else if (openedError === 'emailValidation') {
      errorBtnEmailValidation.style.display = "flex"
    } else if (openedError === 'password') {
      errorBtnPassword.style.display = "flex"
    }
    */
  ...
  const displayEmailConfirmation = (e) => {
    // NEED A PROMISE TO FIX THIS
    ...
    console.log('ZEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE')
    console.log('ZEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE')
    console.log('ZEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE')
    console.log('ZEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE')
    console.log(hiddenEmailValidationInput.style.opacity)
    console.log('ZEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE')
    console.log('ZEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE')
    console.log('ZEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE')
  ...
  const openedAssociatedError = (e) => {
    ...
    /*
    inputElements.forEach((inputElem) => {
      inputElem.style.borer = '1px solid red'
    })
    errorBtnElements.forEach((errorBtn) => {
    ...
    */
    ...
    console.log(errorMessageElemEmail)
  ...
  const canSave = username.length > 2 && regex.test(email) && regex.test(emailValidation) && password.length > 5
  ...
  const tryToRegister = (e) => {
    ...
    console.log(regex.test(emailValidation))
    ...
    if (canSave) {
      try {
        ...
        console.log('**************************')
        console.log('**************************')
        console.log('WE COULDNT TRY TO SAVE')
        console.log('**************************')
        console.log('**************************')
        console.log('**************************')
  ...
  return (
    ...
    <div className="register-main-container">
        <div className="register-container " onClick={(e) => testOverlay(e)}>
          ...
          <div id="register-close-container"className="register-close-btn-container">
            <img  id="register-close-img" src={crossIcon} alt="close register menu" className="register-cross-icon" onClick={ closeRegisterMenu} />
          </div>
        ...
        <div className="register-header">
          ...
          <form id="register-form">
            ...
            <input id="register-input-username"tabIndex="0"  className="register-input username"  placeholder="Prénom" onChange={(e)=>changeUsername(e)} onClick={(e)=>removeRedBorders(e)}></input>
            <div className="error-red username" id="username-error" onClick={(e)=>openedAssociatedError(e)}>
                  <img  src={errorRed} alt="error username" id="username-error-img"></img>
                </div>
              <div className="register-input-error username">Quel est votre nom ?
                <div className="register-error-arrow"></div>
              </div>
            </div>
            
            <div className="register-input-container">
            <input id="register-input-email" className="register-input email" placeholder="Adresse e-mail" onClick={(e) => removeRedBorders(e)} onChange={(e)=>displayEmailConfirmation(e)}></input>
            <div className="error-red email" id="email-error" onClick={(e)=>openedAssociatedError(e)}>
                  <img src={errorRed} alt="error email"></img>
                </div>
              <div className="register-input-error email">Vous en aurez besoin pour vous reconnecter ou si vous devez un jour réinitialiser votre mot de passe.
                <div className="register-error-arrow email"></div>
              </div>
            </div>
            
            <div className="register-input-container emailValidation">
            <input id="register-input-emailValidation"className="register-input emailValidation" placeholder="Adresse e-mail validation" onChange={(e)=>changeEmailValidation(e)} onClick={(e)=>removeRedBorders(e)}></input>
            <div className="error-red emailValidation" id="emailValidation-error" onClick={(e)=>openedAssociatedError(e)}>
                  <img src={errorRed} alt="error emailValidation"></img>
                </div>
              <div className="register-input-error emailValidation">Veuillez saisir de nouveau votre adresse e-mail.
                <div className="register-error-arrow"></div>
              </div>
            </div>
            
            <div className="register-input-container">
            <input id="register-input-password" type="password" className="register-input password" placeholder="Nouveau mot de passe" onChange={(e)=>changePassword(e)} onClick={(e)=>removeRedBorders(e)}></input>
            <div className="error-red password" id="password-error" onClick={(e)=>openedAssociatedError(e)}>
                  <img src={errorRed} alt="error password"></img>
                </div>
              <div className="register-input-error password">Entrez une combinaison d'un moins six caractères.
                <div className="register-error-arrow"></div>
              </div>
            </div>
            
            <div className="register-informations">
              En cliquant sur s'inscrire, vous acceptez que votre email puisse tomber entre de mauvaises mains.
              Mais en utilisant un e-mail jetable, comme <a href="https://www.yopmail.com" target="_blank">yopmail.com</a> vous ne risquez rien.
            </div>
              <button  id="register-btn" className="register-btn" onClick={(e)=>tryToRegister(e)}>S'inscrire</button>
              </form>
          </div>
      </div>
    </div>
