...
import { resetPassword,selectUserByEmail,cancelSearchedAccount } from "../../redux/features/auth/authSlice";
          ...
          <div className="reset-password-middle">
            ...
            <div className="reset-password-middle-right">
              ...
              <div className="reset-password-middle-right-user">
                ...
                <div className="middle-right-user-user">Utilisateur de Clonebook</div>
              </div>
            </div>
          </div>
          <div className="reset-password-btns">
            <button className="reset-password-btn cancel" onClick={navigateToAuth}>Ce n'est pas vous ?</button>
            <button className="reset-password-btn continue" onClick={tryResetPassword}>Continuer</button>
          </div>
        </div>
