...
const ModalProfileFriend = (props) => {
  ...
  const openUserFriendlistModal = (e) => {
    const modalElem = document.querySelector(`.modal-profile-text-modal-friendlist.profile.id-${e.target.id.split('-')[1]}`)
  ...
  return (
    <div className={`modal-profile-friend profile  id-${props.friend.owner_id}`}>
      ...
      <div className="modal-profile-text" >
        <h4 id={props.friend.owner_username}onClick={(e) => navigateToProfile(e)}>{props.friend.owner_username}</h4>
          ...
          {props.friend.users.length == 1 ?
            ...
            <div className={`modal-profile-text-modal-friendlist profile id-${props.friend.owner_id}`} id={props.friend.owner_id} >
